"""
UNet model for liver and tumor segmentation.
"""
import torch
...
class UNet(nn.Module):
    ...
    Args:
        ...
        n_classes: Number of output classes (3 for background/liver/tumor)
        bilinear: Use bilinear upsampling instead of transposed convolutions
        use_batchnorm: Use batch normalization layers
    """
    def __init__(self, n_channels=1, n_classes=3, bilinear=False, use_batchnorm=True):
        super().__init__()
